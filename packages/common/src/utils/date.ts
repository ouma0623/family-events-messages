 ...
 */
export function parseDateToISO8601(dateStr: string, isEnd = false): string {
 ...
 * @returns ISO8601形式の文字列（JST固定）
 */
export function parseDateTimeToISO8601(dateTimeStr: string): string {
  // 日時文字列をパース
 ...
 */
function normalizeDateTimeString(dateTimeStr: string): string | null {
